...
export const TRANSLATIONS: Record<Language, TranslationDictionary> = {
  EN: {
    ...
    birthdayRemindersTitle: "Annual Birthday Reminders & Countdown",
    birthdayRemindersDesc: "Save recurring annual birthday reminders in your local browser storage and track real-time countdowns to upcoming birthdays.",
    addBirthdayReminderBtn: "Add Birthday Reminder",
    saveReminderBtn: "Save Reminder",
    reminderNameLabel: "Person / Name",
    reminderNamePlaceholder: "e.g. Mom, John, Sister, Sarah",
    reminderDateLabel: "Birth Date",
    reminderNoteLabel: "Notes / Relationship (Optional)",
    reminderNotePlaceholder: "e.g. Likes books, turning 30 this year",
    savedRemindersTitle: "Your Saved Annual Birthday Reminders",
    nextBirthdayCountdown: "Upcoming Birthday Countdown Widget",
    noRemindersSaved: "No birthday reminders saved yet. Click 'Add Birthday Reminder' or save a date directly from the Age Calculator!",
    turnsAge: "Turning Age",
    upcomingOn: "Upcoming on",
    reminderSavedToast: "Annual birthday reminder saved locally!",
    reminderDeletedToast: "Birthday reminder deleted!",
    ...
    customNoteLabel: "Custom Note / Label",
    customNotePlaceholder: "Add label or note (e.g. John's Age, Project Sprint)...",
    githubDeployBtn: "GitHub Live Auto-Update",
    githubDeployTitle: "Enable Automatic GitHub Pages Deployment",
    githubDeploySubtitle: "Automatically publish live website updates whenever you sync code from AI Studio to GitHub.",
    githubStep1Title: "1. Copy Workflow Deployment File",
    githubStep1Desc: "Copy the automated GitHub Actions deployment script below to your clipboard:",
    githubStep2Title: "2. Create `.github/workflows/deploy.yml` on GitHub",
    githubStep2Desc: "Go to your GitHub repository (promptnest-official/smart-age-calculator), click 'Add file' -> 'Create new file', enter path `.github/workflows/deploy.yml`, paste the copied code and click 'Commit changes'.",
    githubStep3Title: "3. Enable GitHub Pages Source",
    githubStep3Desc: "In your repository Settings -> Pages -> Build and deployment -> Source, select 'GitHub Actions'.",
    copyWorkflowBtn: "Copy Workflow File Code",
    workflowCopiedToast: "GitHub Actions workflow script copied to clipboard!",
    openGithubRepoBtn: "Open Repository on GitHub",
  },
  DE: {
    title: "Smart Age & Date Calculator Pro",
    ...
    birthdayRemindersTitle: "Jährliche Geburtstagserinnerungen & Countdown",
    birthdayRemindersDesc: "Speichern Sie wiederkehrende jährliche Geburtstagserinnerungen im lokalen Browserspeicher und verfolgen Sie Live-Countdowns.",
    addBirthdayReminderBtn: "Geburtstag hinzufügen",
    saveReminderBtn: "Erinnerung speichern",
    reminderNameLabel: "Name / Person",
    reminderNamePlaceholder: "z.B. Mama, Thomas, Schwester",
    reminderDateLabel: "Geburtsdatum",
    reminderNoteLabel: "Notiz / Beziehung (Optional)",
    reminderNotePlaceholder: "z.B. Liebt Bücher, wird 30",
    savedRemindersTitle: "Ihre gespeicherten Geburtstagserinnerungen",
    nextBirthdayCountdown: "Nächster Geburtstag Countdown-Widget",
    noRemindersSaved: "Noch keine Geburtstagserinnerungen gespeichert. Fügen Sie jetzt Erinnerungen hinzu!",
    turnsAge: "Wird Alt",
    upcomingOn: "Anstehend am",
    reminderSavedToast: "Geburtstagserinnerung lokal gespeichert!",
    reminderDeletedToast: "Geburtstagserinnerung gelöscht!",
    deleteReminderBtn: "Löschen",
    ...
    customNoteLabel: "Eigene Notiz / Bezeichnung",
    customNotePlaceholder: "Notiz oder Bezeichnung hinzufügen (z.B. Johns Geburtstag, Projekt-Sprint)...",
    githubDeployBtn: "GitHub Live-Update",
    githubDeployTitle: "Automatische GitHub Pages Bereitstellung aktivieren",
    githubDeploySubtitle: "Veröffentlicht automatisch Live-Updates Ihrer Website bei jedem GitHub-Sync aus AI Studio.",
    githubStep1Title: "1. Workflow-Datei kopieren",
    githubStep1Desc: "Kopieren Sie das folgende GitHub Actions Skript in Ihre Zwischenablage:",
    githubStep2Title: "2. `.github/workflows/deploy.yml` auf GitHub erstellen",
    githubStep2Desc: "Gehen Sie zu Ihrem Repository (promptnest-official/smart-age-calculator), klicken Sie auf 'Add file' -> 'Create new file', geben Sie den Pfad `.github/workflows/deploy.yml` ein, fügen Sie den Code ein und speichern Sie.",
    githubStep3Title: "3. GitHub Pages Quelle einstellen",
    githubStep3Desc: "Wählen Sie in den Repository-Einstellungen -> Pages -> Source die Option 'GitHub Actions'.",
    copyWorkflowBtn: "Workflow-Code kopieren",
    workflowCopiedToast: "GitHub Actions Skript in die Zwischenablage kopiert!",
    openGithubRepoBtn: "Repository auf GitHub öffnen",
  },
  FR: {
    title: "Smart Age & Date Calculator Pro",
    ...
    birthdayRemindersTitle: "Rappels d'anniversaires annuels & Compte à rebours",
    birthdayRemindersDesc: "Enregistrez des rappels d'anniversaires récurrents dans le stockage local du navigateur et suivez les décomptes en direct.",
    addBirthdayReminderBtn: "Ajouter un rappel",
    saveReminderBtn: "Enregistrer le rappel",
    reminderNameLabel: "Nom / Personne",
    reminderNamePlaceholder: "ex. Maman, Jean, Sœur",
    reminderDateLabel: "Date de naissance",
    reminderNoteLabel: "Note / Relation (Optionnel)",
    reminderNotePlaceholder: "ex. Aime la lecture, fête ses 30 ans",
    savedRemindersTitle: "Vos rappels d'anniversaires enregistrés",
    nextBirthdayCountdown: "Widget compte à rebours d'anniversaire",
    noRemindersSaved: "Aucun rappel d'anniversaire enregistré. Ajoutez vos proches dès maintenant !",
    turnsAge: "Âge fêté",
    upcomingOn: "Prévu le",
    reminderSavedToast: "Rappel d'anniversaire enregistré localement !",
    reminderDeletedToast: "Rappel d'anniversaire supprimé !",
    deleteReminderBtn: "Supprimer",
    ...
    customNoteLabel: "Note / Libellé personnalisé",
    customNotePlaceholder: "Ajouter une note ou un libellé (ex. Âge de Jean, Sprint projet)...",
    githubDeployBtn: "Mise à jour Auto GitHub",
    githubDeployTitle: "Activer le déploiement automatique sur GitHub Pages",
    githubDeploySubtitle: "Publiez automatiquement les mises à jour en direct dès que vous synchronisez depuis AI Studio vers GitHub.",
    githubStep1Title: "1. Copier le fichier de workflow",
    githubStep1Desc: "Copiez le script de déploiement GitHub Actions ci-dessous :",
    githubStep2Title: "2. Créer `.github/workflows/deploy.yml` sur GitHub",
    githubStep2Desc: "Allez sur votre dépôt GitHub, cliquez sur 'Add file' -> 'Create new file', indiquez le chemin `.github/workflows/deploy.yml`, collez le code et validez.",
    githubStep3Title: "3. Activer la source GitHub Pages",
    githubStep3Desc: "Dans Settings -> Pages -> Source, sélectionnez 'GitHub Actions'.",
    copyWorkflowBtn: "Copier le code du workflow",
    workflowCopiedToast: "Script GitHub Actions copié dans le presse-papiers !",
    openGithubRepoBtn: "Ouvrir le dépôt sur GitHub",
  },
  ES: {
    title: "Smart Age & Date Calculator Pro",
    ...
    birthdayRemindersTitle: "Recordatorios de cumpleaños anuales y Cuenta atrás",
    birthdayRemindersDesc: "Guarde recordatorios de cumpleaños recurrentes en el almacenamiento local de su navegador y siga las cuentas atrás en tiempo real.",
    addBirthdayReminderBtn: "Añadir recordatorio",
    saveReminderBtn: "Guardar recordatorio",
    reminderNameLabel: "Nombre / Persona",
    reminderNamePlaceholder: "ej. Mamá, Carlos, Hermana",
    reminderDateLabel: "Fecha de nacimiento",
    reminderNoteLabel: "Nota / Relación (Opcional)",
    reminderNotePlaceholder: "ej. Le gustan los libros, cumple 30",
    savedRemindersTitle: "Sus recordatorios de cumpleaños guardados",
    nextBirthdayCountdown: "Widget de cuenta atrás para el próximo cumpleaños",
    noRemindersSaved: "Aún no hay recordatorios guardados. ¡Añada a sus familiares y amigos!",
    turnsAge: "Cumple la edad de",
    upcomingOn: "Próximo el",
    reminderSavedToast: "¡Recordatorio de cumpleaños guardado localmente!",
    reminderDeletedToast: "¡Recordatorio de cumpleaños eliminado!",
    deleteReminderBtn: "Eliminar",
    ...
    customNoteLabel: "Nota / Etiqueta personalizada",
    customNotePlaceholder: "Añadir etiqueta o nota (ej. Edad de Juan, Sprint de proyecto)...",
    githubDeployBtn: "Auto-Despliegue GitHub",
    githubDeployTitle: "Activar despliegue automático en GitHub Pages",
    githubDeploySubtitle: "Publica automáticamente las actualizaciones en vivo cada vez que sincronices el código desde AI Studio a GitHub.",
    githubStep1Title: "1. Copiar archivo de Workflow",
    githubStep1Desc: "Copia el siguiente script de despliegue de GitHub Actions:",
    githubStep2Title: "2. Crear `.github/workflows/deploy.yml` en GitHub",
    githubStep2Desc: "Ve a tu repositorio en GitHub, haz clic en 'Add file' -> 'Create new file', escribe la ruta `.github/workflows/deploy.yml`, pega el código y guarda los cambios.",
    githubStep3Title: "3. Seleccionar origen GitHub Pages",
    githubStep3Desc: "En Settings -> Pages -> Build and deployment -> Source, selecciona 'GitHub Actions'.",
    copyWorkflowBtn: "Copiar código de Workflow",
    workflowCopiedToast: "¡Script de GitHub Actions copiado al portapapeles!",
    openGithubRepoBtn: "Abrir repositorio en GitHub",
  },
  IT: {
    title: "Smart Age & Date Calculator Pro",
    ...
    birthdayRemindersTitle: "Promemoria compleanni annuali e Conto alla rovescia",
    birthdayRemindersDesc: "Salva promemoria di compleanno ricorrenti nel browser locale e traccia i conti alla rovescia in tempo reale.",
    addBirthdayReminderBtn: "Aggiungi promemoria",
    saveReminderBtn: "Salva promemoria",
    reminderNameLabel: "Nome / Persona",
    reminderNamePlaceholder: "es. Mamma, Marco, Sorella",
    reminderDateLabel: "Data di nascita",
    reminderNoteLabel: "Note / Relazione (Opzionale)",
    reminderNotePlaceholder: "es. Ama i libri, compie 30 anni",
    savedRemindersTitle: "I tuoi promemoria di compleanno salvati",
    nextBirthdayCountdown: "Widget conto alla rovescia prossimo compleanno",
    noRemindersSaved: "Nessun promemoria salvato. Aggiungi subito i tuoi cari!",
    turnsAge: "Compie anni",
    upcomingOn: "In arrivo il",
    reminderSavedToast: "Promemoria di compleanno salvato localmente!",
    reminderDeletedToast: "Promemoria di compleanno eliminato!",
    deleteReminderBtn: "Elimina",
    ...
    customNoteLabel: "Nota / Etichetta personalizzata",
    customNotePlaceholder: "Aggiungi etichetta o nota (es. Età di Marco, Sprint di progetto)...",
    githubDeployBtn: "Auto-Deploy GitHub",
    githubDeployTitle: "Attiva il deployment automatico su GitHub Pages",
    githubDeploySubtitle: "Pubblica automaticamente gli aggiornamenti live del sito ogni volta che sincronizzi il codice da AI Studio a GitHub.",
    githubStep1Title: "1. Copia il file di Workflow",
    githubStep1Desc: "Copia negli appunti lo script di deployment GitHub Actions qui sotto:",
    githubStep2Title: "2. Crea `.github/workflows/deploy.yml` su GitHub",
    githubStep2Desc: "Vai sul tuo repository GitHub, clicca 'Add file' -> 'Create new file', inserisci `.github/workflows/deploy.yml`, incolla il codice e salva.",
    githubStep3Title: "3. Imposta l'origine di GitHub Pages",
    githubStep3Desc: "In Settings -> Pages -> Build and deployment -> Source, seleziona 'GitHub Actions'.",
    copyWorkflowBtn: "Copia codice Workflow",
    workflowCopiedToast: "Script GitHub Actions copiato negli appunti!",
    openGithubRepoBtn: "Apri repository su GitHub",
  }
};
